...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Style Doll Studio — AI fashion styling & moodboards" },
      ...
      { property: "og:title", content: "Style Doll Studio" },
      { property: "og:description", content: "Your dreamy AI styling studio." },
